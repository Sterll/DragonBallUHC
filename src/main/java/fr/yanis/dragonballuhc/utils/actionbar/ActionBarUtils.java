package fr.yanis.dragonballuhc.utils.actionbar;
...
public class ActionBarUtils {
    ...
    private DBUHCMain instance = DBUHCMain.getInstance();

    public ActionBarUtils(){
        CLUpdate clUpdate = new CLUpdate(DBUHCMain.getInstance());
        ...
        Bukkit.getPluginManager().registerEvents(clUpdate, DBUHCMain.getInstance());
    }
